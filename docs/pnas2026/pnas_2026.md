...
Figure 1 shows p-value CDFs for all four statistical tests (panels A–D) across secondary-structure classes, comparing real data (colored curves) vs. randomized control (gray). Panels A–C use permutation tests (K=5000); panel D uses the analytic framework of González-Delgado et al.
