...
class DihedralKDE(object):
    ...
    def __init__(
        ...
        :param k3: Concentration parameter for phi-psi
    ...
    def bvm_kernel(phi: np.ndarray, psi: np.ndarray, k1, k2, k3):
        """
        Bivariate von Mises (BvM) kernel function.
        All angles should be in radians.
        k1, k2, k3 are the concentration parameters.
    ...
    def estimate(self, phi: np.ndarray, psi: np.ndarray):
        ...
        :param phi: First angle values.
        :param psi: Second angle values.
        """
